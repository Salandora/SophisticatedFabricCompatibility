package org.github.salandora.sophisticatedfabriccompat.compat.litematica;
...
public class LitematicaMixinPlugin implements IMixinConfigPlugin {
	private final Map<String, Supplier<Boolean>> mixinMap = Map.of(
			//"org.github.salandora.sophisticatedfabriccompat.compat.litematica.backpacks", () -> Config.CONFIG.LITEMATICA.enableBackpacksCompat()
	);
