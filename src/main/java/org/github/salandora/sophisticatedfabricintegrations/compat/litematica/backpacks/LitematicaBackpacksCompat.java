package org.github.salandora.sophisticatedfabricintegrations.compat.litematica.backpacks;
...
import static org.github.salandora.sophisticatedfabricintegrations.compat.litematica.core.LitematicaCompat.LitematicaWrapper;
...
public class LitematicaBackpacksCompat implements ICompat {
	...
	@Override
	public void setup() {
		if (!Config.CONFIG.LITEMATICA.enableCompat() || !Config.CONFIG.LITEMATICA.enableBackpacksCompat()) {
			return;
		}
